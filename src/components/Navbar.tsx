    ...
    return (
        <div className="navbar bg-black shadow-sm p-0 sticky top-0 z-50 h-[65px]">
            <div className="flex-1 text-left hover:bg-black">
                <a className="inline-flex outline-black outline-none btn-shadown-black bg-black border-none text-xl ml-5 mt-2" href={'/' + prefix}>
                    <img src={logo} alt="ValiDoc" className='h-[40px]'/>
                    <div className='ml-1 mt-0.5 bg-black border-none w-full text-[24px] font-bold font-sans'>ValiDoc</div>
                </a>
            </div>
